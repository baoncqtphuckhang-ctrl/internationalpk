        ...
        <>
            ...
            `}>
                ...
                <nav className="flex-1 px-3 space-y-1 overflow-y-auto custom-scrollbar pb-6">
                    ...
                    <div className="pt-6 pb-2 space-y-1 border-t border-slate-800 mt-4">
                        <p className="text-[10px] text-slate-600 uppercase font-black px-4 tracking-widest mb-2">Công Trình</p>
                                ...
                                <div key={p.id} className="flex flex-col">
                                    {deleteProjectConfirmName === p.name ? (
                                        <div className="mt-1 mx-3 p-3 bg-slate-800 border border-red-900/50 rounded-xl animate-in fade-in">
                                            <p className="text-xs text-red-400 mb-3 font-bold">Xóa dữ liệu công trình này?</p>
                                            <div className="flex gap-2">
                                                <button onClick={() => { onDeleteProject(p.name); setDeleteProjectConfirmName(null); }} className="flex-1 bg-red-600/20 text-red-500 hover:bg-red-600 hover:text-white py-1.5 rounded-lg text-xs font-bold transition">Xóa</button>
                                                <button onClick={() => setDeleteProjectConfirmName(null)} className="flex-1 bg-slate-700 text-slate-300 hover:bg-slate-600 py-1.5 rounded-lg text-xs font-bold transition">Hủy</button>
                                            </div>
                                        </div>
                                    ) : (
                                        <div
