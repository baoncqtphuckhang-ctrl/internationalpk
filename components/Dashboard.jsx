...
export default function Dashboard({ 
    ...
    const computedTotals = useMemo(() => {
        ...
        }), { totalContractAndPlhd: 0, debtToCollect: 0, totalExpense: 0, totalActualIncome: 0, totalReceivedAmount: 0, remainingCost: 0, recoveredAdvance: 0, utilityValue: 0, profit: 0 });
    }, [filteredData]);
